...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="/nepseData/resources//bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="/nepseData/resources//dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/nepseData/resources//dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/nepseData/resources//bower_components/morrisjs/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/nepseData/resources//bower_components/fontawesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <!-- jQuery -->
    <script src="/nepseData/resources//bower_components/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/nepseData/resources//bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="/nepseData/resources//bower_components/metisMenu/dist/metisMenu.min.js"></script>
