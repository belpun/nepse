...
public class GenericRepository implements IGenericRepository {
	...
	public <E> E findById(Class<E> objectClazz, Serializable key) {
		...
		try {
			...
			Object object = session.get(objectClazz, key);
		...
		// Object object = entityManager.find(objectClazz, key);
		// if (object == null) {
		// return (E) object;
		// }
		// return (E) object;
	...
	// Contact yourContact = new Contact(24, "Your Name",
	...
	// ex.printStackTrace();
	//
	// // Rolling back the changes to make the data consistent in case of any
	// failure
	// // in between multiple database write operations.
	// tx.rollback();
	// } finally{
